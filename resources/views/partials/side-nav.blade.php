            <div class="side-nav">
                <div class="side-nav-inner">
                    ...
                    <ul class="side-nav-menu scrollable">
                        <li class="nav-item">
                            <a class="mrg-top-30" href="{{ route('home') }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('payment-methods.index') }}">
                                ...
                                <span class="title">Moyen payement</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ route('unit-measures.index') }}">
                                <span class="icon-holder">
                                        <i class="ti-credit-card"></i>
                                    </span>
                                <span class="title">Unité de mésure</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('expense-types.index') }}">
                                ...
                                <span class="title">Categories Dépenses</span>
                            </a>
                        </li>
