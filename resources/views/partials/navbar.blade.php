                    ...
                    <div class="search-wrapper">
                        <div class="pdd-vertical-10">
                            ...
                            <ul class="list-unstyled list-info">
                                <li>
                                    <a href="#">
                                        <img class="thumb-img" src="images/avatars/thumb-1.jpg" alt="">
                                        <div class="info">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="thumb-img" src="images/avatars/thumb-5.jpg" alt="">
                                        <div class="info">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="thumb-img" src="images/avatars/thumb-4.jpg" alt="">
                                        <div class="info">
                        ...
                        <div class="pdd-vertical-10">
                            ...
                            <ul class="list-unstyled list-info">
                                <li>
                                    <a href="#">
                                        <img class="thumb-img" src="images/img-1.jpg" alt="">
                                        <div class="info">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="thumb-img" src="images/img-2.jpg" alt="">
                                        <div class="info">
